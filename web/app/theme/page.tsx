      ...
      <div className="mx-auto max-w-7xl px-4 py-10">
        ...
        <section className="mb-8">
          ...
          <p className={`mt-2 ${theme.textSecondary}`}>
            Explore the complete UI kit for {theme.name}. Switch themes to see
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className={`rounded-2xl ${theme.glass} p-6`}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <button
                  className={`rounded-lg px-6 py-2.5 font-medium transition-all ${theme.button.primary}`}
                >
                  Start Howling
                </button>
              </div>
              <div>
                ...
                <button
                  className={`rounded-lg px-6 py-2.5 font-medium transition-all ${theme.button.secondary}`}
                >
                  Learn More
                </button>
              </div>
              <div>
                ...
                <button
                  className={`rounded-lg px-6 py-2.5 font-medium transition-all ${theme.button.ghost}`}
                >
                  View Details
                </button>
              </div>
              <div>
                ...
                <button
                  className={`rounded-lg px-6 py-2.5 font-medium transition-all ${theme.button.glass}`}
                >
                  Glass Effect
                </button>
              </div>
          ...
          <section className={`rounded-2xl ${theme.glass} p-6`}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p
                  className={`bg-linear-to-r ${theme.primary} bg-clip-text text-2xl font-bold text-transparent`}
                >
                  {theme.name}
                </p>
              </div>
          ...
          <section className={`rounded-2xl ${theme.glass} p-6`}>
            ...
            <div className={`${theme.tabs.container}`}>
              <div className="flex gap-1">
                <button
                  className={`rounded-t-lg px-4 py-2 text-sm font-medium transition-all ${theme.tabs.active}`}
                >
                  Active Tab
                </button>
                <button
                  className={`rounded-t-lg px-4 py-2 text-sm font-medium transition-all ${theme.tabs.inactive}`}
                >
                  Inactive Tab
                </button>
                <button
          ...
          <section className={`rounded-2xl ${theme.glass} p-6 lg:col-span-2`}>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div
                className={`rounded-xl ${theme.bgCard} ${theme.border} border p-4`}
              >
                <h3 className={`mb-2 font-semibold ${theme.textPrimary}`}>
                  Standard Card
                </h3>
              ...
              <div
                className={`rounded-xl bg-linear-to-br ${theme.primary} p-4`}
              >
            ...
            >
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div
                    className={`h-8 w-8 rounded-full ${theme.primarySolid}`}
                  />
                  <div
                    className={`max-w-xs rounded-2xl ${theme.glass} px-4 py-2`}
                  >
                ...
                <div className="flex items-start justify-end gap-3">
                  <div
                    className={`max-w-xs rounded-2xl bg-linear-to-r ${theme.primary} px-4 py-2`}
                  >
          ...
          <section className={`rounded-2xl ${theme.glass} p-6`}>
            ...
            <div className="space-y-4">
              ...
              <div
                className={`rounded-lg border ${theme.border} ${theme.borderHover} p-3 transition-all cursor-pointer`}
              >
                <p className={`text-sm ${theme.textSecondary}`}>
          ...
          <section className={`rounded-2xl ${theme.glass} p-6`}>
            ...
            <div className="space-y-3">
              <button
                className={`w-full rounded-lg px-4 py-2.5 text-left text-sm transition-all ${theme.button.ghost}`}
              >
                Hover me to see the effect
              </button>
              <button
                className={`w-full rounded-lg px-4 py-2.5 text-left text-sm transition-all ${theme.glassHover} ${theme.glass}`}
              >
                Glass hover effect
              </button>
              <div
                className={`rounded-lg ${theme.bgCard} p-3 transition-all hover:scale-[1.02]`}
              >
                <p className={`text-sm ${theme.textSecondary}`}>
                  Hover to scale
                </p>
        ...
        <section className={`mt-8 rounded-2xl ${theme.glass} p-6`}>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <code
                className={`rounded bg-linear-to-r ${theme.primary} px-2 py-1 text-xs text-white`}
              >
                {theme.id}
              </code>
            </div>
