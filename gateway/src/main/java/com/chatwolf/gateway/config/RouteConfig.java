    ...
    RouteLocator routes(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("user-profile", r -> r.path("/api/v1/users/profile")
                        .filters(f -> f.filter(authenticationFilter).requestRateLimiter(config -> {
                ...
                .route("health", r -> r.path("/health").uri("lb://localhost:8080"))
                .route("metrics", r -> r.path("/metrics").uri("lb://localhost:8080"))
                .route("prometheus", r -> r.path("/prometheus").uri("lb://localhost:8080"))
                .build();
    }
}
